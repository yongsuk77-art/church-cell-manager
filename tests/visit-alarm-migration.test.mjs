...
const migrationSql = readFileSync(
  new URL("../migrations/0018_visit_alarm_notifications.sql", import.meta.url),
  "utf8"
);

test("0018 preserves delivery state and backfills legacy alarms without replaying past ones", () => {
